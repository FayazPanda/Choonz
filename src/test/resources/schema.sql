...
CREATE TABLE IF NOT EXISTS track_playlist (id bigint generated by default as identity, playlists_id bigint not null, tracks_id bigint not null);
...
CREATE TABLE IF NOT EXISTS user (id bigint generated by default as identity, password varchar(255),permissions integer default 0, username varchar(255));